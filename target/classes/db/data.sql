...
('admin', '$2a$10$SlYQmyNdGzTn7ZLB41co2e5.cdL0zS7N3cM02FhN2x46CrrZtZDeK', 'ADMIN');
...
-- Sample orders
INSERT INTO orders (customer_name, location, status, order_type) VALUES
('Arun Kumar', '123 Main Street, Colombo 03', 'PENDING', 'REGULAR'),
('Sarah Johnson', '45 Beach Road, Mount Lavinia', 'APPROVED', 'REGULAR'),
('David Chen', '78 Temple Lane, Kandy', 'REJECTED', 'REGULAR'),
('Maria Garcia', '12 Lake View, Nuwara Eliya', 'PENDING', 'BUFFET');
